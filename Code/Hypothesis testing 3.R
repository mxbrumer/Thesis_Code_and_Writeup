...
#Regressions
##predict DVs
Belongingness ~ C1*CSS + B1*SID + D1*PID
Self Esteem ~ C2*CSS+ B2*SID + D2*PID
Control ~ C3*CSS+ B3*SID + D3*PID
Meaningful Existence ~ C4*CSS + B4*SID + D4*PID
Life_sat ~ C5*CSS + B5*SID + D5*PID
